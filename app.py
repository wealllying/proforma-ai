# app.py — FINAL $1M/YEAR INSTITUTIONAL PRODUCT — 100% WORKING + GORGEOUS DESIGN
...
<style>
    ...
    .metric-card {background: linear-gradient(135deg, #003366, #0055aa); color: white; padding: 20px; border-radius: 16px; text-align: center;}
...
if "paid" not in st.query_params:
    ...
    st.markdown('<div class="footer">© 2025 Pro Forma AI — Institutional Grade Underwriting</div>', unsafe_allow_html=True)
    st.stop()

# ——— MAIN APP — GORGEOUS DARK MODE ———
st.set_page_config(page_title="Pro Forma AI – Institutional", layout="wide")
st.markdown("""
<style>
    .css-1d391kg {padding-top: 2rem;}
    .stMetric {background: linear-gradient(90deg, #003366, #0055aa); color: white; padding: 20px; border-radius: 16px;}
